	...
	<HEAD>
		...
		<script type="text/javascript">
			...
			function confirmDel(cid){
				/* window.location.href = "AdminCategoryServlet?method=delCategory&cid=${c.cid }"; */
				alert(cid);
			...
			$(function(){
				$(".comfirmDel").click(function(){
					var a = this.title;
					if(confirm("确定要删除吗？")){
					 	window.location.href = "AdminCategoryServlet?method=delCategory&cid="+a;
					}
				});
				$("#comfirmDel").click(function(){
					var a = this.title;
								...
								<c:forEach items="${list}" var="c" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="AdminCategoryServlet?method=toEditPage&cid=${c.cid }">
													<img src="${pageContext.request.contextPath}/img/admin/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
									
											<td align="center" style="HEIGHT: 22px">
												<a href="javascript:void(0);" class="comfirmDel" title="${c.cid }" >
													<img src="${pageContext.request.contextPath}/img/admin/i_del.gif" width="16" height="16" border="0" style="CURSOR: hand">
												</a>
												<%-- <a href="javascript:void(0);" onclick="confirmDel(${c.cid})" >
													<img src="${pageContext.request.contextPath}/img/admin/i_del.gif" width="16" height="16" border="0" style="CURSOR: hand">
												</a> --%>
												<!-- 疑问：为什么class选择器能正常的响应，而id选择器不能正常相应 -->
												<%-- <a href="javascript:void(0);" id="comfirmDel" title="${c.cid }" >
													<img src="${pageContext.request.contextPath}/img/admin/i_del.gif" width="16" height="16" border="0" style="CURSOR: hand">
												</a> --%>
											</td>
										</tr>
