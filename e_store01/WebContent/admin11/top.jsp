...
TH {
	...
	<body>
		<table width="100%" height="70%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				<%-- <td width="100%" height="100%" background="${pageContext.request.contextPath}/img/admin/top_100.jpg">
					<img width="100%" height="100%" src="${pageContext.request.contextPath}/img/admin/top_01.jpg">
				</td> --%>

				<%-- <td width="100%" height="100%" background="${pageContext.request.contextPath}/img/admin/top_100.jpg">
				</td> --%>
				<td>
					<img width="100%" height="100%" src="${pageContext.request.contextPath}/img/admin/top_100.jpg" />
				</td>
			</tr>
		</table>
